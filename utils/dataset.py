    ...
    def __getitem__(self, index):
        ...
        for k in range(self.shot):
            ...
            while((support_image_path == image_path and support_label_path == label_path) or support_idx in support_idx_list):
                ...
                support_image_path = support_image_path[1:]
                support_label_path = support_label_path[1:]
        ...
        if self.transform is not None:
            ...
            if self.mode == 'train':
                ...
                image, label, label_b, black_record = self.transform_tri(image, label, label_b)  # transform the triple
        ...
        if self.mode == 'train':
            ...
            return image, label, label_b, s_x, s_y, subcls_list, raw_label, raw_label_b, black_record
