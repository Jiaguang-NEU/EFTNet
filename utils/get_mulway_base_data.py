...
for index in tqdm(range(len(data_list))):
    ...
    image_path, label_path = root_path + image_path, root_path+ label_path  #
    image_path = image_path.replace('../data/VOCdevkit2012', 'data/VOCdevkit2012')
    label_path = label_path.replace('../data/VOCdevkit2012', 'data/VOCdevkit2012')
